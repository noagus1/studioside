...
import { User, Users, LogOut, Settings, Sparkles } from 'lucide-react'
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
...
interface AccountPopoverHeaderProps {
  user: UserProfile
  role: MembershipRole | null
}

/**
 * Account Popover Header Component
 * 
 * Displays user account information and actions in a popover menu.
 * Trigger shows a user icon button in the header (mirroring the sidebar toggle).
 */
export default function AccountPopoverHeader({ user, role }: AccountPopoverHeaderProps) {
